...
class QueryTransSummaryResponse(PosResponse):
    def __init__(self, msg):
        super(QueryTransSummaryResponse, self).__init__(msg)
        self.service = QueryTransSummaryService()
        self.trans_datetime = ''
        self.deal_time = ''
        self.deal_date = ''
        self.sys_trace_id = ''
...
def query_merchant_response(msg):
    response = QueryTransSummaryResponse(msg)
    response.load()
    return response
