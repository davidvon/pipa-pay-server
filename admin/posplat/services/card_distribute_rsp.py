...
class CardDistributeResponse(PosResponse):
    def __init__(self, msg):
        super(CardDistributeResponse, self).__init__(msg)
        self.service = CardDistributeService()
        self.trans_datetime = ''
        self.deal_time = ''
        self.deal_date = ''
        self.sys_trace_id = ''
...
def card_distribute_response(msg):
    response = CardDistributeResponse(msg)
    response.load()
    return response
