...
class FilterNotEqual(BaseSQLAFilter):
    ...
    def operation(self):
        return '不等于' # lazy_gettext('not equal')
...
class FilterLike(BaseSQLAFilter):
    ...
    def operation(self):
        return '包含' # lazy_gettext('contains')
...
class FilterNotLike(BaseSQLAFilter):
    ...
    def operation(self):
        return '不包含' # lazy_gettext('not contains')
...
class FilterGreater(BaseSQLAFilter):
    ...
    def operation(self):
        return '大于' # lazy_gettext('greater than')
...
class FilterSmaller(BaseSQLAFilter):
    ...
    def operation(self):
        return '小于' # lazy_gettext('smaller than')
...
class FilterInList(BaseSQLAFilter):
    ...
    def operation(self):
        return '在列表内' # lazy_gettext('in list')
...
class FilterNotInList(FilterInList):
    ...
    def operation(self):
        return '不在列表内' # lazy_gettext('not in list')
...
class DateNotBetweenFilter(DateBetweenFilter):
    ...
    def operation(self):
        return '不在之间' # lazy_gettext('not between')
